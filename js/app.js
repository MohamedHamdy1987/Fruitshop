...
function showUserMenu() {
  ...
  document.getElementById('user-info').innerHTML = `
      ...
      الاسم: ${meta?.full_name || '-'}
      البريد: ${meta?.email || '-'}
      الشركة: ${meta?.company_name || '-'}
      الدور: ${roleNames[meta?.role]||meta?.role||'-'}
      الاشتراك: ${subNames[meta?.subscription]||meta?.subscription||'-'}
    `;
