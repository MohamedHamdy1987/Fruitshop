...
// ملاحظة: تمت إزالة صفحة 'inventory' نهائياً، وأضيفت 'baqi' و 'nazil'
// ─────────────────────────────────────────────────────────────
const PAGE_RENDERS = {
...
worker: ['dashboard','sales','baqi','nazil','tarhil'],
accountant: ['dashboard','sales','baqi','nazil','tarhil','customers','suppliers','invoices','khazna'],
admin: ['dashboard','sales','baqi','nazil','tarhil','customers','suppliers','invoices','khazna','employees','partners','shops','subscription'],
owner: null
};
...
// دوال مساعدة عامة للتوافق مع الكود القديم
...
// ربط دالة goToTarhilDate بالنافذة لتكون متاحة من أي مكان
